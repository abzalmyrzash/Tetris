...
static inline int64_t getZenTicksPerSecond() {
	return zen_ticks_per_second.QuadPart;
}

static inline int64_t getZenTicksPerMicrosecond() {
	return zen_ticks_per_microsecond;
}
